...
Retcode DicoInit() 
{
    ...
    // AFFICHAGE
    DicoAdd("CR", MOT_NOYAU, DICO_ANTISLASH, DICO_NOYAU, 0L, &Code_Cr, NULL);
    DicoAdd("SPACE", MOT_NOYAU, DICO_ANTISLASH, DICO_NOYAU, 0L, &Code_Space, NULL);
    DicoAdd("EMIT", MOT_NOYAU, DICO_ANTISLASH, DICO_NOYAU, 0L, &Code_Emit, NULL);
